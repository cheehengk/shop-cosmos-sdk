...
const (
	Query_Params_FullMethodName   = "/shop.shop.Query/Params"
	Query_ShowPost_FullMethodName = "/shop.shop.Query/ShowPost"
	Query_ListPost_FullMethodName = "/shop.shop.Query/ListPost"
)
